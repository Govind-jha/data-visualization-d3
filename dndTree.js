...
function save_changes(){
    console.log(d3.keys(tree_root));    
    console.log(d3.entries(tree_root));    
    console.log(getData2.call(tree_root))
...
var menu = [
        ...
        },
        {
            ...
            action: function(elm, d, i) {
                save_changes();
                    console.log('Copy updates from alert box');
            }
    }
]
...
var zoomListener = d3.behavior.zoom().scaleExtent([0.60, 1.8]).on("zoom", zoom);
...
function colorNode(d) {
    ...
    if (d.synthetic == true) {
      ...
      if (d.type == "root") {
        result = (d._children || d.children) ? "green" : "lime";
      } else if (d.type == "Aromas") {
        result = (d._children || d.children) ? "orangered" : "orange";
      } else if (d.type == "Tastes") {
        result = (d._children || d.children) ? "orangered" : "orange";
      } else if (d.type == "sub-aroma") {
        result = (d._children || d.children) ? "yellowgreen" : "yellow";      
      } else if (d.type == "sub-taste") {
        result = (d._children || d.children) ? "yellowgreen" : "yellow";      
      } else {
        result = "lightgray"
      }
